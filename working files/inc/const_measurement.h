...
Koef = ------------
        R*K*0xFFF
де:
K - коефіцієнт передачі і він рівний 82
2500 - максимальне значення напруги у мілівольтах, яке може оцифрувати АЦП (у нас це є 2,5 В = 2500 мВ)
...
Koef = 148,9100330563745197891539354954 для фазних напруг (149/1 = 149) 
...
Koef_1 = 105,29529416087537624364400433648 для фазних струмів (105/1 = 105)
*/

#define MNOGNYK_U                     149           
#define VAGA_DILENNJA_U               0
#define MNOGNYK_U_DIJUCHE             105           
#define VAGA_DILENNJA_U_DIJUCHE       0
#define MNOGNYK_U_DIJUCHE_FLOAT       105.29529416087537624364400433648f
