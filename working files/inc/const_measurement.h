...
K - коефіцієнт передачі і він рівний 8.2
2500 - максимальне значення напруги у мілівольтах, яке може оцифрувати АЦП (у нас це є 2,5 В = 2500 мВ)
R - резистор, з якого напруга знімається. Зараз стоїть 180 Ом
R1 - опір двох додаткових резмсторів у дільнику напруги. Зараз стоять по 470 кОм
0xFFF - максимальне число, яке може видати АЦП

Koef = 2978,1262098335269066976384049555 для фазних напруг (23825/8 = 2978,125) 
...
Koef_1 = 2105,8532382026778286695684303103 для фазних струмів (2106/1 = 2106)
*/

#define MNOGNYK_U                     23825           
#define VAGA_DILENNJA_U               3
#define MNOGNYK_U_DIJUCHE             2106           
#define VAGA_DILENNJA_U_DIJUCHE       0
#define MNOGNYK_U_DIJUCHE_FLOAT       2105.8532382026778286695684303103f
