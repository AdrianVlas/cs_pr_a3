...
enum _index_editor_list_logical_nodes_m2
{
  ...
  INDEX_EDITOR_LIST_LOGICAL_NODES_M2_TS,
  INDEX_EDITOR_LIST_LOGICAL_NODES_M2_INPUT_GOOSE_BLOCKS,
  INDEX_EDITOR_LIST_LOGICAL_NODES_M2_INPUT_MMS_BLOCKS,
  INDEX_EDITOR_LIST_LOGICAL_NODES_M2_NETWORK_OUTPUT_BLOCKS,
