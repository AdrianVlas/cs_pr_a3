...
void min_settings_TU(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_TU(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_TS(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_TS(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_INPUT_GOOSE_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_INPUT_GOOSE_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_INPUT_MMS_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_INPUT_MMS_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_NETWORK_OUTPUT_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_NETWORK_OUTPUT_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_LOG(unsigned int, uintptr_t *, size_t, size_t);
void copy_settings_LOG(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
...
void change_settings_network_layer_Ethrenet(unsigned int);
void make_ekran_choose_passwords(void);
void make_ekran_password(void);
void move_into_editor_list_logical_nodes(unsigned int, int);
...
void move_into_editor_view_chosen_of_selected_logical_node(unsigned int, int);
...
void move_into_list_settings_param(unsigned int, int);
...
void move_into_ekran_list_inputs_outputs(unsigned int, int);
