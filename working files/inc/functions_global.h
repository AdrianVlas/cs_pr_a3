...
__result_dym_mem_select allocate_dynamic_memory_for_settings(__action_dym_mem_select const, unsigned int const, uintptr_t *[], uintptr_t * const[], __CONFIG * const, __CONFIG * const, __CONFIG * const);
