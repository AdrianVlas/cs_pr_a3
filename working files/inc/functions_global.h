...
void min_settings_INPUT(uintptr_t *, size_t, size_t);
void prev_settings_INPUT(uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_OUTPUT(uintptr_t *, size_t, size_t);
void prev_settings_OUTPUT(uintptr_t *, uintptr_t *, size_t, size_t);
void min_settings_LED(uintptr_t *, size_t, size_t);
void prev_settings_LED(uintptr_t *, uintptr_t *, size_t, size_t);
...
void min_settings_MEANDER(uintptr_t *, size_t, size_t);
void prev_settings_MEANDER(uintptr_t *, uintptr_t *, size_t, size_t);
...
__result_dym_mem_select allocate_dynamic_memory_for_settings(unsigned int, unsigned int, uintptr_t *[], uintptr_t *[], __CONFIG *, __CONFIG *);
