...
extern void copy_settings_BUTTON(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
...
extern void min_settings_INPUT_GOOSE_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
extern void copy_settings_INPUT_GOOSE_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_INPUT_MMS_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
extern void copy_settings_INPUT_MMS_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_NETWORK_OUTPUT_BLOCK(unsigned int, uintptr_t *, size_t, size_t);
extern void copy_settings_NETWORK_OUTPUT_BLOCK(unsigned int, unsigned int, uintptr_t *, uintptr_t *, size_t, size_t);
...
extern enum _result_pressed_enter_during_edition press_enter_in_settings_network_layer_Ethernet(void);
extern void press_esc_in_settings_network_layer_Ethernet(void);
extern void change_settings_network_layer_Ethernet(unsigned int);
