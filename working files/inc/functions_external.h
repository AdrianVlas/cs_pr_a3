...
extern void min_settings(__SETTINGS_OLD *);
extern void min_settings_INPUT(uintptr_t *, size_t, size_t);
extern void prev_settings_INPUT(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_OUTPUT(uintptr_t *, size_t, size_t);
extern void prev_settings_OUTPUT(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_LED(uintptr_t *, size_t, size_t);
extern void prev_settings_LED(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_AND(uintptr_t *, size_t, size_t);
extern void prev_settings_AND(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_OR(uintptr_t *, size_t, size_t);
extern void prev_settings_OR(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_XOR(uintptr_t *, size_t, size_t);
extern void prev_settings_XOR(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_NOT(uintptr_t *, size_t, size_t);
extern void prev_settings_NOT(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_TIMER(uintptr_t *, size_t, size_t);
extern void prev_settings_TIMER(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_TRIGGER(uintptr_t *, size_t, size_t);
extern void prev_settings_TRIGGER(uintptr_t *, uintptr_t *, size_t, size_t);
extern void min_settings_MEANDER(uintptr_t *, size_t, size_t);
extern void prev_settings_MEANDER(uintptr_t *, uintptr_t *, size_t, size_t);
...
extern __result_dym_mem_select allocate_dynamic_memory_for_settings(unsigned int, unsigned int, uintptr_t *[], uintptr_t *[], __CONFIG *, __CONFIG *);
extern unsigned int action_after_changing_of_configuration(unsigned int, __SETTINGS_OLD *);
extern void action_after_changing_number_el(__SETTINGS_OLD *, unsigned int);
