...
typedef struct
{
  ...
  unsigned int edition;               //0 - вікно зараз не в режимі редагується;
                                      //1 - вікно зараз не в режимі редагується але з правом переходу в режим редагування без додаткої перевірки паролю;
                                      //2 - вікно зараз в режимі редагування;
                                      //3 - вікно чекає підтвердження редагування
                                      //4 - у вікні виведено повідомлення про те, що під час введення даних була зафіксована помилка величиниданих
