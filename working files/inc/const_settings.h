...
Вх.GOOSE блок
*/
#define NUMBER_INF_INPUTS_INPUT_GOOSE_BLOCK     8
#define NUMBER_OUTPUTS_INPUT_GOOSE_BLOCK    NUMBER_INF_INPUTS_INPUT_GOOSE_BLOCK

enum _INPUT_GOOSE_BLOCK_output_signals
{
  INPUT_GOOSE_BLOCK_OUT1 = 0,

  INPUT_GOOSE_BLOCK_SIGNALS_OUT = (INPUT_GOOSE_BLOCK_OUT1 + NUMBER_OUTPUTS_INPUT_GOOSE_BLOCK)
    
};

enum _INPUT_GOOSE_BLOCK_inf_input_signals
{
  INPUT_GOOSE_BLOCK_BLK_G = 0,
  
  INPUT_GOOSE_BLOCK_SIGNALS_IN
    
};

enum _INPUT_GOOSE_BLOCK_internal_input_signals
{
  INPUT_GOOSE_BLOCK_INT_MUTEX = 0,
  INPUT_GOOSE_BLOCK_INT_IN1,
  
  INPUT_GOOSE_BLOCK_SIGNALS_INT_IN = (INPUT_GOOSE_BLOCK_INT_IN1 + NUMBER_INF_INPUTS_INPUT_GOOSE_BLOCK)
};
...
Вх.MMS блок
*/
#define NUMBER_INF_INPUTS_INPUT_MMS_BLOCK     8
#define NUMBER_OUTPUTS_INPUT_MMS_BLOCK    NUMBER_INF_INPUTS_INPUT_MMS_BLOCK

enum _INPUT_MMS_BLOCK_output_signals
{
  INPUT_MMS_BLOCK_OUT1 = 0,

  INPUT_MMS_BLOCK_SIGNALS_OUT = (INPUT_MMS_BLOCK_OUT1 + NUMBER_OUTPUTS_INPUT_MMS_BLOCK)
    
};

enum _INPUT_MMS_BLOCK_input_signals
{
  INPUT_MMS_BLOCK_BLK_G = 0,
  INPUT_MMS_BLOCK_BLK_LR,
  
  INPUT_MMS_BLOCK_SIGNALS_IN
    
};

enum _INPUT_MMS_BLOCK_internal_input_signals
{
  INPUT_MMS_BLOCK_INT_MUTEX = 0,
  INPUT_MMS_BLOCK_INT_IN1,
  
  INPUT_MMS_BLOCK_SIGNALS_INT_IN = (INPUT_MMS_BLOCK_INT_IN1 + NUMBER_INF_INPUTS_INPUT_MMS_BLOCK)
};

/***/

/*
Мережевий вихідний блок блок
*/
#define NUMBER_INPUTS_NETWORK_OUTPUT_BLOCK     8
#define NUMBER_OUTPUTS_NETWORK_OUTPUT_BLOCK    NUMBER_INPUTS_NETWORK_OUTPUT_BLOCK

enum _NETWORK_OUTPUT_BLOCK_output_signals
{
  NETWORK_OUTPUT_BLOCK_OUT1 = 0,

 NETWORK_OUTPUT_BLOCK_SIGNALS_OUT = (NETWORK_OUTPUT_BLOCK_OUT1 + NUMBER_OUTPUTS_NETWORK_OUTPUT_BLOCK)
    
};

enum _NETWORK_OUTPUT_BLOCK_input_signals
{
  NETWORK_OUTPUT_BLOCK_LOGIC_INPUT1 = 0,
  
  NETWORK_OUTPUT_BLOCK_BLK_G = (NETWORK_OUTPUT_BLOCK_LOGIC_INPUT1 + NUMBER_INPUTS_NETWORK_OUTPUT_BLOCK),
