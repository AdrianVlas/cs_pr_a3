...
enum _menu2_levels
{
  MAIN_MANU2_LEVEL = 0,
    ...
    INPUTS_OUTPUTS_MENU2_LEVEL,
      ANALOG_INPUTS_MENU2_LEVEL,
      INPUTS_MENU2_LEVEL,
      OUTPUTS_MENU2_LEVEL,
    REGISTRATORS_MENU2_LEVEL,
      LOG_LIST_MENU2_LEVEL,
        LOG_DATA_MENU2_LEVEL,
      PR_ERR_LIST_MENU2_LEVEL,
        PR_ERR_DATA_MENU2_LEVEL,
    ...
    LIST_SETTINGS_MENU2_LEVEL = __BEGIN_SETTINGS_MENU2_LEVEL,
      ...
      EDITOR_LIST_LOGICAL_NODES_FOR_INPUT_MENU2_LEVEL,
        ...
        EDITOR_LIST_TSS_FOR_INPUT_MENU2_LEVEL,
        EDITOR_LIST_INPUT_GOOSE_BLOCKS_FOR_INPUT_MENU2_LEVEL,
        EDITOR_LIST_INPUT_MMS_BLOCKS_FOR_INPUT_MENU2_LEVEL,
        EDITOR_LIST_NETWORK_OUTPUT_BLOCKS_FOR_INPUT_MENU2_LEVEL,
...
//                  EDITOR_LIST_OUTPUTS_OF_SELECTED_LOGICAL_NODE_MENU2_LEVEL = __NEXT_AFTER_EDITOR_LIST_SELECTED_TYPE_LOGICAL_NODE_FOR_OUTPUT_MENU2_LEVEL,
      ...
      LIST_SETTINGS_COMMUNIACATION_PARAMETERS_MENU2_LEVEL,
        ...
        LIST_CHOOSE_SETTING_RS485_MENU2_LEVEL,
          LIST_PHY_LAYER_RS485_MENU2_LEVEL,
            BAUD_RS485_MENU2_LEVEL,
            PARE_RS485_MENU2_LEVEL,
            STOP_BITS_RS485_MENU2_LEVEL,
            TIMEOUT_RS485_MENU2_LEVEL,
          LIST_PROTOCOL_RS485_MENU2_LEVEL,
            ADDRESS_MENU2_LEVEL,
        LIST_CHOOSE_SETTING_ETHERNET_MENU2_LEVEL,  
          SETTINGS_NETWORK_LAYER_ETHERNET_MENU2_LEVEL,
