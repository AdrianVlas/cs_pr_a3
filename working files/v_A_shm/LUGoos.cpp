        ...
        if (l > 0) {
            ...
            if (j > 0)
                rCLUGoose.arrOut[(Goose__1_8_OUT_NAME__CO_8-1)] = 1;
                 k |= 1 << ((Goose__1_8_OUT_NAME__CO_8-1) % 8);
        } 
