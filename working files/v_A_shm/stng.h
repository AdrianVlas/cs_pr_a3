...
MAX_AMOUNT_LU_AND     = 60,  
MAX_AMOUNT_LU_OR      = 60,  
MAX_AMOUNT_LU_XOR     = 60,
MAX_AMOUNT_LU_NOT     = 60, 
MAX_AMOUNT_LU_TIMERS  = 60,
MAX_AMOUNT_LU_TRIGGERS = 65,
MAX_AMOUNT_LU_ALARMS   = 55,
MAX_AMOUNT_LU_MEANDERS = 65,
MAX_AMOUNT_LU_INPUT    = 19,
MAX_AMOUNT_LU_OUTPUT   = 7,
MAX_AMOUNT_LU_LED      = 22,
MAX_AMOUNT_LU_FKey     = 5,
MAX_AMOUNT_LU_LSS      = 32,
MAX_AMOUNT_LU_BGS      = 22,
MAX_AMOUNT_LU_TRIG     = 30,
MAX_AMOUNT_LU_ALT     = 60,
MAX_AMOUNT_LU_TU     = 20,
MAX_AMOUNT_LU_TS     = 20,
MAX_AMOUNT_LU_GOOSE     = 40,
MAX_AMOUNT_LU_MMS       = 40,
MAX_AMOUNT_LU_LAN       = 40,
MAX_AMOUNT_LU_LOG    = 1
